...
var Swiper = (function () {
      ...
      for (let e = 0, t = o.length; e < t; e += 1) {
        ...
        r(s[t]) && r(a)
          ? a.__swiper__
            ...
            : n(s[t], a)
          : !r(s[t]) && r(a)
            ? ((s[t] = {}), a.__swiper__ ? (s[t] = a) : n(s[t], a))
            : (s[t] = a);
      }
    }
    return s;
  ...
  var F = {
    ...
    loopFix: function (e = {}) {
      ...
      (p.emit("beforeLoopFix"), (p.__loopFixInProgress__ = !0));
      const {
          slides: u,
          allowSlidePrev: m,
          allowSlideNext: h,
      ...
      const x = g.slidesPerGroupAuto ? S : g.slidesPerGroup,
        T = (e) => ("function" == typeof e ? e.call(p) : e) || 0,
        M =
          p.slidesGrid.length > 1
            ? (p.slidesGrid[p.slidesGrid.length - 1] - p.slidesGrid[0]) /
              (p.slidesGrid.length - 1)
            : p.size,
        C = M > 0 ? T(w) / M : 0,
        P = M > 0 ? T(b) / M : 0;
      let L = E
        ? Math.max(x, (v ? Math.ceil(S / 2) : 0) + Math.ceil(Math.max(C, P)))
        : x;
      (L % x !== 0 && (L += x - (L % x)),
        (L += g.loopAdditionalSlides),
        (p.loopedSlides = L));
      const I = p.grid && g.grid && g.grid.rows > 1;
      u.length < S + L || ("cards" === p.params.effect && u.length < S + 2 * L)
        ? c(
      ...
      const A = [],
        z = [],
        $ = I ? Math.ceil(u.length / g.grid.rows) : u.length,
        k = n && $ - y < S && !E;
      let O = k ? y : p.activeIndex;
      void 0 === d
        ? (d = p.getSlideIndex(
      ...
      const H =
        (I ? (u[d].column ?? 0) : d) +
        (E && void 0 === r ? (v ? -S / 2 + 0.5 : 0) - C : 0);
      if (H < L) {
        X = Math.max(L - H, x);
        for (let e = 0; e < L - H; e += 1) {
          const t = e - Math.floor(e / $) * $;
          if (I) {
            const e = $ - t - 1;
            for (let t = u.length - 1; t >= 0; t -= 1)
              u[t].column === e && A.push(t);
          } else A.push($ - t - 1);
        }
      } else if (H + S > $ - L) {
        ((B = Math.max(H - ($ - 2 * L), x)),
          k && (B = Math.max(B, S - $ + y + 1)));
        for (let e = 0; e < B; e += 1) {
          const t = e - Math.floor(e / $) * $;
          I
            ? u.forEach((e, s) => {
      ...
      if (
        ...
        "cards" === p.params.effect &&
          ...
          A.includes(d) && A.splice(A.indexOf(d), 1)),
        G &&
          A.forEach((e) => {
            const t = u[e];
        ...
        if (A.length > 0 && G) {
          if (void 0 === t) {
            const e = p.slidesGrid[O],
              t = p.slidesGrid[O + X] - e;
            o
              ? p.setTranslate(p.translate - t)
              : (p.slideTo(O + Math.ceil(X), 0, !1, !0),
                r &&
            ...
            const e = I ? A.length / g.grid.rows : A.length;
            (p.slideTo(p.activeIndex + e, 0, !1, !0),
              (p.touchEventsData.currentTranslate = p.translate));
          }
        } else if (z.length > 0 && D)
          if (void 0 === t) {
            const e = p.slidesGrid[O],
              t = p.slidesGrid[O - B] - e;
            o
              ? p.setTranslate(p.translate - t)
              : (p.slideTo(O - B, 0, !1, !0),
                r &&
            ...
            const e = I ? z.length / g.grid.rows : z.length;
            p.slideTo(p.activeIndex - e, 0, !1, !0);
          }
      ((p.allowSlidePrev = m), (p.allowSlideNext = h));
      const Y = p.controller?.control;
      if (Y && !l) {
        const e = {
          slideRealIndex: t,
          direction: i,
        ...
        Array.isArray(Y)
          ...
          : Y instanceof p.constructor &&
            Y.params.loop &&
            Y.loopFix({
              ...e,
              slideTo: Y.params.slidesPerView === g.slidesPerView && s,
            });
      }
      ((p.__loopFixInProgress__ = !1), p.emit("loopFix"));
    },
  ...
  var J = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if (o && "auto" === s.slidesPerView)
            (s.virtual?.slidesPerViewAutoSlideSize &&
              (I = s.virtual.slidesPerViewAutoSlideSize),
              I &&
                r &&
                (s.roundLengths && (I = Math.floor(I)),
                (r.style[e.getDirectionLabel("width")] = `${I}px`)));
          else if ("auto" === s.slidesPerView) {
            A && (r.style[e.getDirectionLabel("width")] = "");
            ...
            if (
              ...
              I = e.isHorizontal() ? v(r, "width") : v(r, "height");
            else {
              const e = t(i, "width"),
                s = t(i, "padding-left"),
                a = t(i, "padding-right"),
            ...
            ((I = (x - (s.slidesPerView - 1) * T) / s.slidesPerView),
              s.roundLengths && (I = Math.floor(I)),
              r && (r.style[e.getDirectionLabel("width")] = `${I}px`));
          (r && (r.swiperSlideSize = I),
            g.push(I),
            s.centeredSlides
              ? ((M = M + I / 2 + C / 2 + T),
                0 === C && 0 !== i && (M = M - x / 2 - T),
      ...
      if (
        ...
        L && e.grid.updateWrapperSize(I, h),
        !s.centeredSlides)
      ) {
      ...
      (Object.assign(t, {
        ...
        t.__loopFixInProgress__ ||
          ...
          (t.initialized || t.params.runCallbacksOnInit) &&
            ((t.__lastEmittedRealIndex__ ?? n) !== u &&
    ...
    mount(e) {
      ...
      return (
        Object.assign(t, {
          el: i,
          wrapperEl: n,
          slidesEl: t.isElement && !l.slideSlots ? l : n,
  ...
  const ye = [
    ({ swiper: e, extendParams: t, on: s, emit: i }) => {
      ...
      function c(t, s, r) {
        ...
        let I = (e.slidesGrid[P] || 0) - (e.slidesGrid[0] || 0);
        function A() {
          (e.updateSlides(),
            e.updateProgress(),
            e.updateSlidesClasses(),
        ...
        if (
          (p && E >= C
            ? ((P -= C), l || (I += e.slidesGrid[0]))
            : p && E < C && ((P = -C), l && (I += e.slidesGrid[0])),
          ...
          return (
            e.slidesGrid !== b &&
              ...
              e.slides.forEach((t) => {
                t.style.setProperty(
                  S,
                  I - Math.abs(e.cssOverflowAdjustment()) + "px",
                );
              }),
            e.updateProgress(),
        ...
        if (z.renderExternal) {
          ...
          return (
            z.renderExternal.call(e, { offset: I, from: P, to: L, slides: t }),
            void (z.renderExternalUpdate ? A() : i("virtualUpdate"))
          );
        }
        const $ = [],
          k = [],
    ...
    ({ swiper: e, extendParams: t, on: s, emit: r }) => {
      ...
      function $(t) {
        ...
        let r, l, o, c, p, m, h, w, b, y, E, x, T, M, C, P, L, I;
        ((g.maxRatio = S()),
          e.params.cssMode &&
      ...
      function G() {
        ...
        (e.wrapperEl.addEventListener("pointerdown", M, s),
          ...
          e.wrapperEl.addEventListener("pointermove", I, i));
      }
      function X() {
        const t = e.zoom;
        if (!t.enabled) return;
        ...
        (e.wrapperEl.removeEventListener("pointerdown", M, s),
          ...
          e.wrapperEl.removeEventListener("pointermove", I, i));
      }
      (Object.defineProperty(e.zoom, "scale", {
        ...
        s("touchStart", (t, s) => {
          e.zoom.enabled &&
            (function (t) {
              ...
              ((v.touchesStart.x = i.pageX),
                (v.touchesStart.y = i.pageY),
                g.imageEl &&
        ...
        s("transitionEnd", () => {
          e.zoom.enabled && a().enabled && A();
        }),
        s("slideChange", () => {
          e.zoom.enabled && a().enabled && e.params.cssMode && A();
        }),
        ...
        setTranslate: () => {
          ...
          for (let i = 0; i < t.length; i += 1) {
            ...
            if (n) {
              ...
              (0 === u && e > 0 && (c = !0), u > 0 && d.push(m), o.push(m));
            }
            ((m.style.opacity = String(u)),
              (m.style.transform = `translate3d(${a}px, ${l}px, 0px)`));
          }
          n &&
            (o.forEach((e) => {
